...
public class OrderController {
    ...
    public Order cancelOrder(@PathVariable(value = "id") String id, @RequestBody CancelOrderCommand cancelOrderCommand, HttpServletRequest request, HttpServletResponse response) throws Exception {
